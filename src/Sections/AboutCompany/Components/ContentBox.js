  ...
  return (
    <div className="flex flex-col justify-center bg-white content-Shadow group hover:shadow-sm duration-500 w-11/12 md:w-[35rem]">
      <div className="flex flex-col items-start justify-center px-6 py-8 text-center md:text-left md:p-10">
        ...
        <p className="my-2 text-base">Shri Bai Industries is one of the quality manufacturer of various types of Conveyor & Conveyor Chains. The company is working in the heart of Rajkot city (Atika) since last five years. The company is run by young and energetic Mr. Premji Devaliya.</p>
