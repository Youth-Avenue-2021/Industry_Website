  ...
  return (
    <div className="flex flex-col justify-center bg-white content-Shadow group hover:shadow-sm duration-500 w-11/12 md:w-[35rem]">
      <div className="flex flex-col items-start justify-center px-6 py-8 text-center md:text-left md:p-10">
        ...
        <p className="my-2 text-base">Established in the year 2000 in Rajkot, Gujarat, “Shree Bai industries”, has established itself as a formidable enterprise involved in manufacturing supplying an immaculate range of Conveyor Systems & Conveyor Chains. The company is run by young and energetic <mark>Mr. Premji Devaliya.</mark> </p>
        ...
        <Link to="/" className="px-5 py-2 mx-auto my-5 duration-300 bg-white border-2 md:mx-0 md:hover:ml-2 hover:bg-yellowColor border-yellowColor">
          Learn More <i className="ml-1 fa-solid fa-angles-right"></i>
        </Link>
      </div>
    </div>
  );
