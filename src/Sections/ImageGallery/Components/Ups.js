...
const CustomModal = () => (
    <Popups trigger={<button className="button"> Open Modal </button>} modal contentStyle={contentStyle}>
        {(close) => (
            <div className="modal bg-[#F5F5F5] p-5 border-2 border-[#FDE047]">
                ...
                <div className="content text-base text-black"> Conveyor Attachment Chain offered comes in durable construction finish can be made available in different surface color options like natural, black and others. Further, the latest process technology used in its manufacturing as well as superior heat treatment and anti-fatigue support also makes these attachment chains for conveyors provide for reliable performance. Some of its features include sutiable for use in areas like packing machines, luggage conveyor, food production line and others; deliver constant transmission ratio; provide for longer service life; working temperature between -10°C to 150°C.</div>
